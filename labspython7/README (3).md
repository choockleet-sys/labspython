...
**Цель работы:** Переписать приложение для расчёта потребления электроэнергии с использованием классов и объектов: абстрактный базовый класс, иерархия наследования, managed-атрибуты и dunder-методы. GUI-фреймворк заменён с `tkinter` на `PyQt5`.
...
1. [PyQt5 — документация](https://www.riverbankcomputing.com/static/Docs/PyQt5/)
...
6. `PyQt5` — библиотека для создания графических интерфейсов, более современная альтернатива `tkinter`. Использует сигналы и слоты для обработки событий.
